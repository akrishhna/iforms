Iforms::Application.routes.draw do
  ...
  devise_for :admins
  devise_for :users, :path => 'users', :path_names => { :sign_in => 'login', :sign_out => 'logout', :sign_up => 'signup' }, :controllers => {:registrations => 'registrations', :confirmations => 'confirmations'}
