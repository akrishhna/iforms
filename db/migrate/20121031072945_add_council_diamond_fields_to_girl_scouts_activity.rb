class AddCouncilDiamondFieldsToGirlScoutsActivity < ActiveRecord::Migration
  ...
  def up
    ...
    add_column :girl_scouts_activities, :leader_advisor_1_first_name, :string
    add_column :girl_scouts_activities, :leader_advisor_1_last_name, :string
    ...
    add_column :girl_scouts_activities, :leader_advisor_2_first_name, :string
    add_column :girl_scouts_activities, :leader_advisor_2_last_name, :string
    ...
    add_column :girl_scouts_activities, :troop_leader_emergency_contact_first_name, :string
    add_column :girl_scouts_activities, :troop_leader_emergency_contact_last_name, :string
  ...
  def down
    ...
    remove_column :girl_scouts_activities, :leader_advisor_1_first_name
    remove_column :girl_scouts_activities, :leader_advisor_1_last_name
    ...
    remove_column :girl_scouts_activities, :leader_advisor_1_phone_3
    ...
    remove_column :girl_scouts_activities, :leader_advisor_2_first_name
    remove_column :girl_scouts_activities, :leader_advisor_2_last_name
    ...
    remove_column :girl_scouts_activities, :troop_leader_emergency_contact_first_name
    remove_column :girl_scouts_activities, :troop_leader_emergency_contact_last_name
