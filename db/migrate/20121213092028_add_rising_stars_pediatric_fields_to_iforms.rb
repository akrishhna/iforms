class AddRisingStarsPediatricFieldsToIforms < ActiveRecord::Migration
  def up
    ...
    add_column :iforms, :patient_previously_siblings, :string, :limit => 15
    add_column :iforms, :patient_previously_siblings_list, :string, :limit => 100

    #Patient/Guardian Information
    add_column :iforms, :patient_guardian_father, :boolean
    add_column :iforms, :patient_guardian_step_father, :boolean
    add_column :iforms, :patient_guardian_father_guardian, :boolean
    add_column :iforms, :patient_guardian_father_other, :boolean
    add_column :iforms, :patient_guardian_father_other_name, :string, :limit => 50
    ...
    add_column :iforms, :patient_guardian_father_employment_place, :string, :limit => 50
    ...
    add_column :iforms, :patient_guardian_mother, :boolean
    add_column :iforms, :patient_guardian_step_mother, :boolean
    add_column :iforms, :patient_guardian_mother_guardian, :boolean
    add_column :iforms, :patient_guardian_mother_other, :boolean
    add_column :iforms, :patient_guardian_mother_other_name, :string, :limit => 50
    ...
    add_column :iforms, :patient_guardian_mother_employment_place, :string, :limit => 50
    ...
    #Insurance
    add_column :iforms, :insurance_do_you_have_dental_insurance, :boolean
    ...
    add_column :iforms, :insurance_place_of_employment, :string, :limit => 50
    ...
    add_column :iforms, :insurance_claim_mail_address, :string, :limit => 50

    #Dental History
    add_column :iforms, :dental_history_why_is_your_child_here_today, :string
    add_column :iforms, :dental_history_child_first_time_to_visit, :string, :limit => 15
    add_column :iforms, :dental_history_child_last_visiting_date, :date
    add_column :iforms, :dental_history_child_behave_today_friendly, :boolean
    add_column :iforms, :dental_history_child_behave_today_happy, :boolean
    add_column :iforms, :dental_history_child_behave_today_timid, :boolean
    add_column :iforms, :dental_history_child_behave_today_afraid, :boolean
    add_column :iforms, :dental_history_child_behave_today_resistance, :boolean
    add_column :iforms, :dental_history_child_receive_fluoride_in_any_form, :string, :limit => 15
    add_column :iforms, :dental_history_child_receive_fluoride_in_any_form_description, :string, :limit => 15
    add_column :iforms, :dental_history_child_inherited_any_dental_characteristics, :string, :limit => 50
    add_column :iforms, :dental_history_child_have_any_injuries, :string, :limit => 50
    ...
    add_column :iforms, :dental_history_other_description, :string, :limit => 50
    ...
    #Medical History
    add_column :iforms, :medical_history_child_physician, :string, :limit => 50
    ...
    add_column :iforms, :medical_history_good_general_health, :boolean
    add_column :iforms, :medical_history_good_general_health_description, :string, :limit => 50
    add_column :iforms, :medical_history_child_physical_disabilities, :boolean
    add_column :iforms, :medical_history_child_physical_disabilities_description, :string, :limit => 50
    add_column :iforms, :medical_history_booster_shoot_up_to_date, :boolean
    add_column :iforms, :medical_history_child_surgical_operations, :boolean
    add_column :iforms, :medical_history_child_surgical_operations_description, :string, :limit => 50
    add_column :iforms, :medical_history_child_ever_been_hospitalized, :boolean
    add_column :iforms, :medical_history_child_ever_been_hospitalized_description, :string, :limit => 50

    add_column :iforms, :medical_history_latex_allergies, :boolean
    add_column :iforms, :medical_history_seasonal_allergies, :boolean
    add_column :iforms, :medical_history_food_allergies, :string, :limit => 50
    add_column :iforms, :medical_history_drug_allergies, :string, :limit => 50

    add_column :iforms, :medical_history_asthama_or_breathing_prob, :string, :limit => 50
    add_column :iforms, :medical_history_er_for_asthma_attack, :string, :limit => 50
    ...
    Social History
    add_column :iforms, :social_history_child_have_problems_speech, :boolean
    add_column :iforms, :social_history_child_have_problems_hearing, :boolean
    add_column :iforms, :social_history_child_have_problems_vision, :boolean
    add_column :iforms, :social_history_child_have_problems_sleep, :boolean

    add_column :iforms, :social_history_consider_ur_child_adv_in_learning, :boolean
    add_column :iforms, :social_history_consider_ur_child_progressing_normally, :boolean
    add_column :iforms, :social_history_consider_ur_child_slow_learner, :boolean

    add_column :iforms, :social_history_child_first_lang, :string, :limit => 50
    add_column :iforms, :social_history_child_second_lang, :string, :limit => 50

    add_column :iforms, :social_history_child_adopted, :string, :limit => 5
    add_column :iforms, :social_history_child_adopted_age, :string, :limit => 20
    add_column :iforms, :social_history_child_tolerate, :string, :limit => 50
    add_column :iforms, :social_history_child_favorites, :string, :limit => 50
  end
  ...
  def down
    ...
    remove_column :iforms, :patient_previously_siblings
    remove_column :iforms, :patient_previously_siblings_list

    #Patient/Guardian Information
    remove_column :iforms, :patient_guardian_father
    remove_column :iforms, :patient_guardian_step_father
    remove_column :iforms, :patient_guardian_father_guardian
    remove_column :iforms, :patient_guardian_father_other
    remove_column :iforms, :patient_guardian_father_other_name
    ...
    remove_column :iforms, :patient_guardian_father_employment_place
    ...
    remove_column :iforms, :patient_guardian_step_mother
    remove_column :iforms, :patient_guardian_mother_guardian
    remove_column :iforms, :patient_guardian_mother_other
    remove_column :iforms, :patient_guardian_mother_other_name
    ...
    remove_column :iforms, :patient_guardian_mother_employment_place
    ...
    #Insurance
    remove_column :iforms, :insurance_do_you_have_dental_insurance
    ...
    remove_column :iforms, :insurance_place_of_employment
    ...
    remove_column :iforms, :insurance_claim_mail_address

    #Dental History
    remove_column :iforms, :dental_history_why_is_your_child_here_today
    remove_column :iforms, :dental_history_child_first_time_to_visit
    remove_column :iforms, :dental_history_child_last_visiting_date
    remove_column :iforms, :dental_history_child_behave_today_friendly
    remove_column :iforms, :dental_history_child_behave_today_happy
    remove_column :iforms, :dental_history_child_behave_today_timid
    remove_column :iforms, :dental_history_child_behave_today_afraid
    remove_column :iforms, :dental_history_child_behave_today_resistance
    remove_column :iforms, :dental_history_child_receive_fluoride_in_any_form
    remove_column :iforms, :dental_history_child_receive_fluoride_in_any_form_description
    remove_column :iforms, :dental_history_child_inherited_any_dental_characteristics
    remove_column :iforms, :dental_history_child_have_any_injuries
    ...
    remove_column :iforms, :dental_history_other_description
    ...
    #Medical History
    remove_column :iforms, :medical_history_child_physician
    ...
    remove_column :iforms, :medical_history_good_general_health
    remove_column :iforms, :medical_history_good_general_health_description
    remove_column :iforms, :medical_history_child_physical_disabilities
    remove_column :iforms, :medical_history_child_physical_disabilities_description
    remove_column :iforms, :medical_history_booster_shoot_up_to_date
    remove_column :iforms, :medical_history_child_surgical_operations
    remove_column :iforms, :medical_history_child_surgical_operations_description
    remove_column :iforms, :medical_history_child_ever_been_hospitalized
    remove_column :iforms, :medical_history_child_ever_been_hospitalized_description
    ...
    remove_column :iforms, :medical_history_er_for_asthma_attack
    ...
    Social History
    remove_column :iforms, :social_history_child_have_problems_speech
    remove_column :iforms, :social_history_child_have_problems_hearing
    remove_column :iforms, :social_history_child_have_problems_vision
    remove_column :iforms, :social_history_child_have_problems_sleep

    remove_column :iforms, :social_history_consider_ur_child_adv_in_learning
    remove_column :iforms, :social_history_consider_ur_child_progressing_normally
    remove_column :iforms, :social_history_consider_ur_child_slow_learner

    remove_column :iforms, :social_history_child_first_lang
    remove_column :iforms, :social_history_child_second_lang

    remove_column :iforms, :social_history_child_adopted
    remove_column :iforms, :social_history_child_adopted_age
    remove_column :iforms, :social_history_child_tolerate
    remove_column :iforms, :social_history_child_favorites
  end
end
