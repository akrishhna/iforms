class Iform < ActiveRecord::Base
  ...
  def self.rising_stars_pediatric_form_generator(iform)
    ...
    @pdftk.fill_form(pdffilepath+"#{@pdf_form}.pdf", path, {
      ...
      # Social History Tab
      "AdoptedAge" => iform.social_history_patient_adopted == 'Yes' ? (iform.social_history_patient_adopted_age ? (iform.social_history_patient_adopted_age.to_s + " " + iform.social_history_patient_adopted_age_years_months.to_s) : '') : '',
      ...
      "DateOfLastVisit" => iform.dental_history_patient_first_time_to_visit == 'No' ? (iform.dental_history_patient_last_visiting_date ? iform.dental_history_patient_last_visiting_date.strftime('%m-%d-%Y') : '') : '',
      ...
      "RheumaticHeartDiseaseOrFeverNo" => iform.medical_history_rheumatic_heart_disease_or_fever == 'No' ? 'Yes' : '',
      "RheumaticHeartDiseaseOrFeverYes" => iform.medical_history_rheumatic_heart_disease_or_fever == 'Yes' ? 'Yes' : '',
      ...
      "CleftLipOrPalateNo" => iform.medical_history_cleft_lip_or_palate == 'No' ? 'Yes' : '',
      "CleftLipOrPalateYes" => iform.medical_history_cleft_lip_or_palate == 'Yes' ? 'Yes' : '',
      ...
      "HospitalizationDescription" => iform.medical_history_patient_ever_been_hospitalized == 'Yes' ? iform.medical_history_patient_ever_been_hospitalized_description : '',
      ...
      "NotInGoodHealthDescription" => iform.medical_history_patient_good_general_health == 'No' ? iform.medical_history_patient_good_general_health_description : '',
      "OperationsDescription" => iform.medical_history_patient_surgical_operations == 'Yes' ? iform.medical_history_patient_surgical_operations_description : '',
      "PhysicalDisabilitiesAndDevelopmentalDelaysDescription" => iform.medical_history_patient_physical_disabilities == 'Yes' ? iform.medical_history_patient_physical_disabilities_description : '',
      ...
      "ProlongedBleedingTransfusionsNo" => iform.medical_history_prolonged_bleeding_or_transfusions == 'No' ? 'Yes' : '',
      "ProlongedBleedingTransfusionsYes" => iform.medical_history_prolonged_bleeding_or_transfusions == 'Yes' ? 'Yes' : '',
