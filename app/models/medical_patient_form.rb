class MedicalPatientForm < ActiveRecord::Base
  ...
  def self.capital_medical_clinic_generate_pdf(medical_patient_form, appointment)
    ...
    @pdftk.fill_form(form_pdf_path, permission_form_path, {
      ...
      "PrimaryInsuranceStateZip" => @medical_patient_form.primary_insurance_address_state.to_s + ' ' + @medical_patient_form.primary_insurance_address_zip.to_s,
      ...
      "OpeartionAndDateB" => @medical_patient_form.medical_history_operations_operation_2.to_s + ' ' + (@medical_patient_form.medical_history_operations_operation_date_2 ? @medical_patient_form.medical_history_operations_operation_date_2.strftime('%m-%d-%Y').to_s : ''),
      "OpeartionAndDateC" => @medical_patient_form.medical_history_operations_operation_3.to_s + ' ' + (@medical_patient_form.medical_history_operations_operation_date_3 ? @medical_patient_form.medical_history_operations_operation_date_3.strftime('%m-%d-%Y').to_s : ''),
      "OpeartionAndDateD" => @medical_patient_form.medical_history_operations_operation_4.to_s + ' ' + (@medical_patient_form.medical_history_operations_operation_date_4 ? @medical_patient_form.medical_history_operations_operation_date_4.strftime('%m-%d-%Y').to_s : ''),
      "OpeartionAndDateE" => @medical_patient_form.medical_history_operations_operation_5.to_s + ' ' + (@medical_patient_form.medical_history_operations_operation_date_5 ? @medical_patient_form.medical_history_operations_operation_date_5.strftime('%m-%d-%Y').to_s : ''),
      "OpeartionAndDateF" => @medical_patient_form.medical_history_operations_operation_6.to_s + ' ' + (@medical_patient_form.medical_history_operations_operation_date_6 ? @medical_patient_form.medical_history_operations_operation_date_6.strftime('%m-%d-%Y').to_s : ''),
