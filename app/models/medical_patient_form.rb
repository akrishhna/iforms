class MedicalPatientForm < ActiveRecord::Base
  ...
  def self.capital_medical_clinic_generate_pdf(medical_patient_form, appointment)
    ...
    @pdftk.fill_form(form_pdf_path, permission_form_path, {
      ...
      "PrimaryInsurancePolicyHolderDateofBirth" => @medical_patient_form.primary_insurance_birth_date,
      ...
      "PrimaryInsurancePolicyHolderSocialSecurityNumber" => @medical_patient_form.primary_insurance_ssn_1.to_s + '-' + @medical_patient_form.primary_insurance_ssn_2.to_s + '-' + @medical_patient_form.primary_insurance_ssn_3.to_s,
      ...
      "SecondaryInsurancePolicyHolderDateofBirth" => @medical_patient_form.secondary_insurance_birth_date,
      ...
      "SecondaryInsurancePolicyHolderSocialSecurityNumber" => @medical_patient_form.secondary_insurance_ssn_1.to_s + '-' + @medical_patient_form.secondary_insurance_ssn_2.to_s + '-' + @medical_patient_form.secondary_insurance_ssn_3.to_s,
      ...
      "HaveYouEverSmokedTobaccoYes" => @medical_patient_form.social_history_smoking_tobacco != "Never" ? 'Yes' : 'No',
      "HaveYouEverSmokedTobaccoNo" => @medical_patient_form.social_history_smoking_tobacco == "Never" ? 'Yes' : 'No',
      ...
      "SmokeTobaccoNowYes" => @medical_patient_form.social_history_smoking_tobacco == "I smoke now" ? 'Yes' : 'No',
      "SmokeTobaccoNowNo" => @medical_patient_form.social_history_smoking_tobacco != "I smoke now" ? 'Yes' : 'No',
      ...
      "HaveYouHadASkinCancerScreeningCheckedByADermatologistNo" => @medical_patient_form.health_maintenance_skin_cancer_screening ? 'No' : 'Yes',
      "HaveYouHadASkinCancerScreeningCheckedByADermatologistYes" => @medical_patient_form.health_maintenance_skin_cancer_screening ? 'Yes' : 'No',
      "SkinCancerScreeningCheckDate" => @medical_patient_form.health_maintenance_skin_cancer_screening,

      "CholesterolTestDate" => @medical_patient_form.health_maintenance_test_date,
      ...
      "WasYourColonoscopyNormal" => @medical_patient_form.health_maintenance_colonoscopy_test_results == "Normal" ? 'Yes' : 'No',
      ...
      "HaveYouEverHadAnAbnormalPapSmearYes" => @medical_patient_form.health_maintenance_abnormal_pap_smear ? 'Yes' : 'No',
      "HaveYouEverHadAnAbnormalPapSmearNo" => @medical_patient_form.health_maintenance_abnormal_pap_smear ? 'No' : 'Yes',
      "AbnormalPapSmearDate" => @medical_patient_form.health_maintenance_abnormal_pap_smear,
      "HaveYouHadAHysterectomyYes" => @medical_patient_form.health_maintenance_hysterectomy ? 'Yes' : 'No',
      "HaveYouHadAHysterectomyNo" => @medical_patient_form.health_maintenance_hysterectomy ? 'No' : 'Yes',
      "HysterectomyDate" => @medical_patient_form.health_maintenance_hysterectomy,
