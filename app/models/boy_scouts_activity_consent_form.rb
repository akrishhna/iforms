class BoyScoutsActivityConsentForm < ActiveRecord::Base
  ...
  def self.activity_parent_permission_form_pdf_generater(activity, boy_scouts_permission_form, permission_form_path)
    ...
    @pdftk.fill_form(form_pdf_path, permission_form_path, {
      ...
      "Without_Restrictions" => @boy_scouts_permission_form.bacf_restriction ? (@boy_scouts_permission_form.bacf_restriction == 'without_restrictions' ? 'No' : 'Yes') : '',
      "Special_considerations" => @boy_scouts_permission_form.bacf_restriction == "with_restrictions" ? boy_scouts_permission_form.bacf_spcl_considerations_for_restriction : '',
