class StaticData < ActiveRecord::Base
  ...
  def self.user_service_types
    [
     ['James Waters','1'],['Central Texas','2'],['Diamonds of AR, OK, and TX','3'],
     ['Karen Naples','4'],['Capital Medical Clinic','5'],['Boy Scouts Leader','6'],
     ['Rising Stars Pediatric Dentistry','7'],['Girl Scouts Alaska','8'],['Girl Scouts Arizona Cactus Pine','9'],
     ['Girl Scouts Black Diamond','10'],["Girl Scouts California's Central Coast",'11'],["Girl Scouts Central & Southern New Jersey",'12']
    ]
  end

  def self.girl_scouts_sign_up_service_type
    [
     [' ',''],['Central Texas','2'],['Diamonds of AR, OK, and TX','3'],['Girl Scouts Alaska','8'],
     ['Girl Scouts Arizona Cactus Pine','9'],['Girl Scouts Black Diamond','10'],["Girl Scouts California's Central Coast",'11'],
     ["Girl Scouts Central & Southern New Jersey",'12']
    ]
  end
